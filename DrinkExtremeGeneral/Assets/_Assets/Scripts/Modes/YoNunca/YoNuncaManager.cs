...
//TODO: Documentation
public class YoNuncaManager : AModeManager
{
    ...
    public static YoNuncaManager instance;
    private new void Awake()
    {
        base.Awake(); //Mandatory

        Debug.Log("Initializing a new YoNuncaManager.");
        if (instance == null)
        {
            instance = this;
            Debug.Log("YoNuncaManager initialization successful.");
        }
        else
        {
            Debug.LogError("YoNuncaManager already exists. New initialization unsuccessful.");
        }
    }
